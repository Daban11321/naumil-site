...
export default function AuthenticatePage() {
  ...
  const handleVerify = async (e: React.FormEvent) => {
    ...
    // For demo: if both fields have at least 4 characters, show success
    if (serialNumber.length >= 4 && naCode.length >= 4) {
      setStatus("success")
    } else {
      setStatus("failed")
    }
        ...
        <div className="mx-auto max-w-xl px-4">
          ...
          {status === "idle" || status === "loading" ? (
            ...
            <div className="mt-8 rounded-xl border border-green-200 bg-green-50 p-8 text-center">
              ...
              <p className="mt-2 text-green-700">
                This is a genuine Naumil product. Thank you for choosing quality.
              </p>
              <Button onClick={resetForm} variant="outline" className="mt-6 min-h-[44px]">
            ...
            <div className="mt-8 rounded-xl border border-red-200 bg-red-50 p-8 text-center">
              ...
              <p className="mt-2 text-red-700">
                We could not verify this product. Please check the codes and try again, or contact us for assistance.
              </p>
              <Button onClick={resetForm} variant="outline" className="mt-6 min-h-[44px]">
                Try Again
              </Button>
          ...
          <div className="mt-12 text-center">
            ...
            <p className="mt-2 text-sm text-muted-foreground">
              Contact us at{" "}
              <a href="mailto:info@naumil.com" className="font-medium text-foreground underline">
                info@naumil.com
              </a>
            </p>
          </div>
